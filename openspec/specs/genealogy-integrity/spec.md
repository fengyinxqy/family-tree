...
Define the genealogy integrity rules that every relationship write path must enforce so family graphs always remain consistent.
...
- **THEN** the system SHALL reject the candidate with an ncestry_cycle error
